      ...
      <div className="w-full max-w-md mt-8">
        <div className="bg-white/80 rounded-3xl shadow-xl p-6 mb-8 flex flex-col items-center">
          ...
          <p className="text-sm text-gray-500">
            {isSignedIn ? "Welcome back!" : "Try our memory game with the ThinkClear founders!"}
          </p>
        </div>
            ...
            <Link href="/faces">
              <div className="bg-white/90 border border-blue-100 rounded-2xl shadow-lg p-6 flex flex-col items-center hover:scale-105 hover:shadow-2xl transition-transform cursor-pointer">
                ...
                <p className="text-xs text-blue-500 text-center">
                  {isSignedIn ? "See recognized faces from your smart glasses." : "Meet the ThinkClear founders."}
                </p>
              </div>
            </Link>
            ...
            <Link href="/game">
              <div className="bg-white/90 border border-blue-100 rounded-2xl shadow-lg p-6 flex flex-col items-center hover:scale-105 hover:shadow-2xl transition-transform cursor-pointer">
                ...
                <p className="text-xs text-pink-400 text-center">
                  {isSignedIn ? "Test memory with friendly challenges." : "Play with the ThinkClear team!"}
                </p>
              </div>
            </Link>
            ...
            <Link href="/journal">
              <div className="bg-white/90 border border-blue-100 rounded-2xl shadow-lg p-6 flex flex-col items-center hover:scale-105 hover:shadow-2xl transition-transform cursor-pointer">
                ...
                <p className="text-xs text-blue-400 text-center">
                  {isSignedIn ? "Record moments and reflections daily." : "Sign in to access your journal."}
                </p>
              </div>
            </Link>
            ...
            <Link href="/progress">
              <div className="bg-white/90 border border-blue-100 rounded-2xl shadow-lg p-6 flex flex-col items-center hover:scale-105 hover:shadow-2xl transition-transform cursor-pointer">
                ...
                <p className="text-xs text-green-500 text-center">
                  {isSignedIn ? "Track your memory game performance." : "Sign in to track your progress."}
                </p>
              </div>
            </Link>
        </div>
